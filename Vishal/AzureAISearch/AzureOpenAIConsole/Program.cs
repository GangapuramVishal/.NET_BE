...
namespace AzureOpenAIConsole
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            OpenAIClient aiClient = new(new Uri("https://eekels.openai.azure.com/"), new Azure.AzureKeyCredential("ccc8ed9efa9c4c5db25b28df6f113318"));
                ...
                AzureExtensionsOptions = new AzureChatExtensionsOptions()
                {
                    Extensions =
                    {
                        new AzureSearchChatExtensionConfiguration()
                        {
                            ...
                            Authentication = new OnYourDataApiKeyAuthenticationOptions("oT8f1mmu5XRZyV8VKBZ23NbKOemPlojonWPNVdfAiKAzSeDkXDmz"),
